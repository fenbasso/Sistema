...
begin
  ...
  begin
    ...
    MessageBox(Handle, 'Informe a Descrição do Produto', 'Atenção', MB_ICONEXCLAMATION or MB_OK);
  ...
  begin
    ...
    MessageBox(Handle, 'Informe o Preço de Venda', 'Atenção', MB_ICONEXCLAMATION or MB_OK);
  ...
  begin
    ...
    EXCEPT
      ...
      MessageBox(Handle, 'Valor inválido para o Preço de Venda', 'Atenção', MB_ICONEXCLAMATION or MB_OK);
