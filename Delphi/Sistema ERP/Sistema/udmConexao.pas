...
begin
  ...
  TRY
    if IOResult <> 0 then
      MessageBox(Application.Handle, 'Ocorreu um Erro na leitura do arquivo de parâmetros de Conexão', 'Atenção', MB_ICONEXCLAMATION or MB_OK)
    else
    begin
      i := 0;
      SetLength(vArray, 7);
      ...
      EXCEPT
        ...
        begin
          ...
          MessageBox(Application.Handle, PChar('Ocorreu um ao Conectar ao Banco!' + #13#10 + E.Message), 'Atenção', MB_ICONEXCLAMATION or MB_OK)
        end;
      END;
    end;
  FINALLY
